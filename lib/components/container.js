...
var containerBase = (0, _compose2.default)((0, _getContext2.default)(contextTypes), (0, _shouldUpdate2.default)(function (props, nextProps) {
    ...
    var restProps = _objectWithoutProperties(props, ['version', 'data']);
...
function loadContainerDataUntilSettled(state) {
    ...
    if (query !== prev) {
        return _rxjs.Observable.from(falcor.get.apply(falcor, _toConsumableArray(_falcorQuerySyntax2.default.call(null, query)))).map(function (_ref6) {
            var json = _ref6.json;
