...
e));return e}},function(b,c,a){function d(a,e){var f=a,m,k=0,h=e.length;if(0<h){do for(f=f[e[k]];f&&(m=f.$type)===g;)f=d(a,f.value);while(++k<h&&f&&!m)}return f}var g=a(0);b.exports=d},function(b,c,a){function d(a,f,e,n,h,m,k,b,v,u,r,C,c,G,H,I,K){var q={},l=f<a.length-1,y=a[f],w=p(y,q),B=C.index;do{r.depth=f;var t=g(e,n,h,m,k,b,w,l,!1,r,C,c,G,H,I,K);r[f]=w;r.index=f;var x=t[0],z=t[1],D=t[4];D[D.index++]=w;x&&(l?d(a,f+1,e,z,x,m,t[3],t[2],v,u,r,D,c,G,H,I,K):(v.push(r.slice(0,r.index+1)),u.push(D.slice(0,
D.index))));w=p(y,q);if(q.done)break;C.index=B}while(1)}function g(a,d,k,q,b,p,c,F,E,A,x,C,D,G,H,I){for(E=k.$type;E===e;){a:{d=a;b=q;x=A;var l=C,y=D,w=G,t=H,B=I,z,J,M=k.value;E=M.slice(0);if(m(k))v(k,y,w),k=void 0,z=d,J=b,E.index=M.length;else{var P=0,N=k,O=M.length-1;z=k=d;J=p=b;do{var L=M[P],Q=P<O;E.index=P;J=g(d,z,k,b,J,p,L,Q,!0,x,E,l,y,w,t,B);k=J[0];E=J[4];if(h(k)){E.index=P;x=J;break a}z=J[1];p=J[2];J=J[3]}while(P++<O);E.index=P;N["\u001e\u0192alcor_context"]!==k&&n(N,k)}f[0]=k;f[1]=z;f[2]=p;
f[3]=J;f[4]=E;x=f}k=x[0];if(h(k))return x;d=x[1];p=x[2];b=x[3];x=x[4];E=k.$type}if(void 0===E){if(null==c){if(F)throw new r;k&&(c=k["\u001e\u0192alcor_key"])}else d=k,b=p,k=d[c],p=b&&b[c];k=u(d,k,p,c,A,x,C,D,G,H,I)}f[0]=k;f[1]=d;f[2]=p;f[3]=b;f[4]=x;return f}var f=Array(5),e=a(0),n=a(12),m=a(123),k=a(3),h=a(8),v=a(6),p=a(4).iterateKeySet,u=a(125),r=a(10);b.exports=function(a,e,g,n){var h=a._root,q=h.expired,m=h.version++,b=h.cache;a=b["\u001e\u0192alcor_version"];for(var p=[],l=[],v=[],y=[],u=-1,
r=e.length;++u<r;)for(var t=e[u],c=t.paths,t=t.jsonGraph,K=-1,S=c.length;++K<S;){var R=c[K];l.index=0;d(R,0,b,b,b,t,t,t,v,y,p,l,m,q,h,n,g)}f[0]=void 0;f[1]=void 0;f[2]=void 0;f[3]=void 0;f[4]=void 0;e=b["\u001e\u0192alcor_version"];g=h.onChange;k(g)&&a!==e&&g();return[v,y]}},function(b,c,a){var d=a(1);b.exports=function(a){return d(a)&&"json"in a}},function(b,c,a){var d=Array.isArray,g=a(1);b.exports=function(a){return g(a)&&(d(a.path)||"string"===typeof a.path)}},function(b,c){b.exports=function(){}},
...
!h?{}:b._seed||(b._seed={})],v=d(b,l,a,v,y,q,f,h);return v?g(this,b,v,a,f,1,this.initialCacheVersion,l,h):(a=b._root,h=a.cache,f=h["\u001e\u0192alcor_version"],this.forceCollect&&n(a,a.expired,m(h),b._maxSize,b._collectRatio,f),b=a.onChangesCompleted,this.initialCacheVersion!==f&&0>=a.syncRefCount&&k(b)&&b.call(a.topLevelModel),e)}},function(b,c,a){function d(a,f,b,k,n,m,l,p,y,u,r,t,c,K){var q;if(v(a)&&!a.$type){q=[];var w=0;e(a)&&(q[w++]="length");for(var C in a)"\u001e"!==C[0]&&"$"!==C[0]&&h(a,
C)&&(q[w++]=C)}else q=void 0;if(q&&q.length){w=0;C=q.length;var B=y.index;do{var z=q[w],x=a[z],D=v(x)&&!x.$type;p.depth=f;var A=g(b,k,n,z,x,D,!1,p,y,u,r,t,c,K);p[f]=z;p.index=f;var G=A[0],E=A[1],A=A[2];A[A.index++]=z;G&&(D?d(x,f+1,b,E,G,m,l,p,A,u,r,t,c,K):(m.push(p.slice(0,p.index+1)),l.push(A.slice(0,A.index))));if(++w>=C)break;y.index=B}while(1)}}function g(a,d,e,b,k,h,v,u,C,c,G,H,I,K){for(var q=e.$type;q===n;){a:{d=k;C=a;var q=u,w,B=c,z=G,x=H,D=I,A=K,E,F=e.value;w=F.slice(0);if(p(e))t(e,z,x),e=
void 0,E=C,w.index=F.length;else{var O=e;e=e["\u001e\u0192alcor_context"];if(null!=e)E=e["\u001e\u0192alcor_parent"]||C,w.index=F.length;else{var L=0,Q=F.length-1;w.index=L;E=e=C;do{E=g(C,E,e,F[L],d,L<Q,!0,q,w,B,z,x,D,A);e=E[0];w=E[2];if(r(e)){w.index=L;C=E;break a}E=E[1]}while(L++<Q);w.index=L;O["\u001e\u0192alcor_context"]!==e&&m(O,e)}}f[0]=e;f[1]=E;f[2]=w;C=f}e=C[0];if(r(e))return C;d=C[1];C=C[2];q=e&&e.$type}if(void 0===q){if(null==b){if(h)throw new y;e&&(b=e["\u001e\u0192alcor_key"])}else d=
e,e=d[b];e=l(d,e,b,k,h,v,u,C,c,G,H,I,K)}f[0]=e;f[1]=d;f[2]=C;return f}var f=Array(3),e=Array.isArray,n=a(0),m=a(12),k=a(19),h=a(14),v=a(1),p=a(2),u=a(3),r=a(8),t=a(6),l=a(61),y=a(10);b.exports=function(a,e,b,g){var q=a._root,n=q.expired,h=q.version++,m=a._path,l=q.cache,p=k(l,m),y=p["\u001e\u0192alcor_parent"]||l;a=l["\u001e\u0192alcor_version"];for(var v=[],r=[],w=[],t=m.length,c=-1,B=e.length;++c<B;){var z=e[c],T=m.slice(0);T.index=t;d(z.json,0,l,y,p,r,w,v,T,h,n,q,g,b)}f[0]=void 0;f[1]=void 0;f[2]=
void 0;e=l["\u001e\u0192alcor_version"];q=q.onChange;u(q)&&a!==e&&q();return[r,w]}},function(b,c,a){function d(a,f,e,b,k,n,h,m,p,v,r,t,c,H,I){var q={},l=e<f.length-1,y=f[e],w=u(y,q),C=v.index;do{p.depth=e;p[e]=w;p.index=e;var B=g(b,k,n,w,a,l,!1,p,v,r,t,c,H,I);p[e]=w;p.index=e;var z=B[0],x=B[1],B=B[2];B[B.index++]=w;z&&(l?d(a,f,e+1,b,x,z,h,m,p,B,r,t,c,H,I):(h.push(p.slice(0,p.index+1)),m.push(B.slice(0,B.index))));w=u(y,q);if(q.done)break;v.index=C}while(1)}function g(a,d,b,h,m,u,c,E,A,x,C,D,G,H){for(var l=
b.$type;l===e;){a:{d=m;A=a;var l=E,q,y=x,w=C,B=D,z=G,F=H,J,M=b.value;q=M.slice(0);if(k(b))p(b,w,B),b=void 0,J=A,q.index=M.length;else{var P=b;b=b["\u001e\u0192alcor_context"];if(null!=b)J=b["\u001e\u0192alcor_parent"]||A,q.index=M.length;else{var N=0,O=M.length-1;J=b=A;do{var L=M[N],Q=N<O;q.index=N;J=g(A,J,b,L,d,Q,!0,l,q,y,w,B,z,F);b=J[0];q=J[2];if(v(b)){q.index=N;A=J;break a}J=J[1]}while(N++<O);q.index=N;P["\u001e\u0192alcor_context"]!==b&&n(P,b)}}f[0]=b;f[1]=J;f[2]=q;A=f}b=A[0];if(v(b))return A;
d=A[1];A=A[2];l=b.$type}if(!u||void 0===l){if(null==h){if(u)throw new t;b&&(h=b["\u001e\u0192alcor_key"])}else d=b,b=d[h];b=r(d,b,h,m,u,c,E,A,x,C,D,G,H)}f[0]=b;f[1]=d;f[2]=A;return f}var f=Array(3),e=a(0),n=a(12),m=a(19),k=a(2),h=a(3),v=a(8),p=a(6),u=a(4).iterateKeySet,r=a(61),t=a(10);b.exports=function(a,e,b,g){var k=a._root,n=k.expired,q=k.version++,p=a._path,l=k.cache,v=m(l,p),y=v["\u001e\u0192alcor_parent"]||l;a=l["\u001e\u0192alcor_version"];for(var u=[],r=[],w=[],t=p.length,c=-1,S=e.length;++c<
...
return b}},function(b,c){b.exports=function(a,d){var b=[],f=a.length;for(d=d||0;d<f;d++)b[d]=a[d];return b}},function(b,c){b.exports={$ref:"ref",$atom:"atom",$error:"error"}},function(b,c,a){function d(a,b,g){var k,h=e(String(b)),m=Object.create(null),q=[],p=-1,v=0,u=[],r=0,c,A,x,C,D,G;x=[];C=-1;if(b<g-1){for(D=f(a,x);++C<D;)k=x[C],c=d(a[k],b+1,g),A=c.code,m[A]?c=m[A]:(q[v++]=A,c=m[A]={keys:[],sets:c.sets}),h=e(h+k+A),n(k)&&c.keys.push(parseInt(k,10))||c.keys.push(k);for(;++p<v;)if(k=q[p],c=m[k],
x=c.keys,D=x.length,0<D)for(a=c.sets,b=-1,g=a.length,C=x[0];++b<g;){k=a[b];c=-1;A=k.length;G=Array(A+1);for(G[0]=1<D&&x||C;++c<A;)G[c+1]=k[c];u[r++]=G}}else for(D=f(a,x),1<D?u[r++]=[x]:u[r++]=x;++C<D;)h=e(h+x[C]);return{code:h,sets:u}}function g(a,d){return a-d}function f(a,d,e){var b=0;if(a===v)d[b++]=null;else{for(var f in a)d[b++]=f;1<b&&d.sort(e)}return b}function e(a){for(var d=5381,e=-1,b=a.length;++e<b;)d=(d<<5)+d+a.charCodeAt(e);return String(d)}function n(a){var d=a,e=typeof a;if("string"===
e){d=a.length;if(0===d||17<d||!h.test(a))return!1;if(16>d)return!0;d=+a}else if("number"!==e)return!1;return 0===d%1&&9007199254740991>=k(d)}var m=Array.isArray,k=Math.abs,h=/^(0|(\-?[1-9][0-9]*))$/,v=a(25);b.exports=function(a){var e,b=[],f=0,k;for(k in a){var h;if(h=n(k))h=e=a[k],h=null!==h&&"object"===typeof h;if(h){h=d(e,0,parseInt(k,10)).sets;for(var q=-1,p=h.length;++q<p;){for(var v=f++,c=h[q],F=-1,E=c.length;++F<E;){var A=c[F];if(m(A)){var x=c,C=F;for(var D=-1,G=A.length-1,H=0<G;++D<=G;){var I=
A[D];if(!n(I)){H=!1;break}A[D]=parseInt(I,10)}!0===H&&(A.sort(g),D=A[0],H=A[G],H-D<=G&&(A={from:D,to:H}));x[C]=A}}b[v]=c}}}return b};b.exports._isSafeNumber=n},function(b,c,a){function d(a,b,m,k){if(m===k)return!0;var e,n=-1,p=0,c,r=m+1,t,l,y;e=b[m];if(null===e)return f;a=a||{};a:do{if("object"!==typeof e)m=e,l=void 0,t=!1;else if(g(e)){if(void 0!==y)break a;n=0;y=e;p=e.length;if(0===p)break a;e=y[n];continue a}else{l=e.to;m=e.from||0;"number"!==typeof l&&(l=m+(e.length||0)-1);if(0>l-m)break a;t=
...
k,c,p,t,l);k=a&&a.value;if(b&&void 0===k){if(y)return c.hasValue=!0,{$type:f}}else return c.hasValue=!0,l?d(a):k}},function(b,c,a){var d=a(16),g=a(11),f=a(2),e=a(6);b.exports=function(a,b,k,h,c,p,u,r,t,l,y,q,w,B,z,F,E,A,x){if(!a||!b){if(z&&!F){if(c)return p.hasValue=!0,{$type:d};return}return x(k,h,p,u,r,t,l)}if(f(a))return a["\u001e\u0192alcor_invalidated"]||e(a,w,q),x(k,h,p,u,r,t,l);g(q,a);if(c)return y&&(u[h]=null),A(a,b,h,c,p,u,t,l,y,B,z,E)}},function(b,c,a){b.exports=function(a,b){var d=b["\u001e\u0192alcor_prev"],
...
null;r=b.hasValue;var z=b.values[0],F=!!(z&&z.json||z.jsonGraph),E=!b.requestedMissingPaths||!b.requestedMissingPaths.length||!a._source;if(b.errors)for(var A=b.errors,x=u.length,C=0,D=A.length;C<D;++C,++x)u[x]=A[C];v&&q&&(z=d(z,q));if(r&&h||F&&E)try{if(c&&z){var G=z.paths;G&&0<G.length&&(z.paths=g(G))}++a._root.syncRefCount;k.onNext(z)}catch(H){throw H;}finally{--a._root.syncRefCount}if(E){if(u.length)k.onError(u);else k.onCompleted();return null}B&&p[0]&&(n=p[0].json)&&(l=n["\u001e\u0192alcor_metadata"])&&
...
p=a(6),u=a(60),r=a(63),t=a(15),l=a(62);b.exports=function(a,b,c,B,z,F,E,A,x,C,D,G,H){var q=f(b,F);if(z||F){if(q&&m(b)&&(q="expired",p(b,C,D)),q&&q!==d||k(b))b=r(b,{},a,c,D,x),b=u(b,a,c,x,A)}else z=f(B),F=!1===n(B)<n(b),(q||z)&&h(G)&&(F=!G(b,B,A.slice(0,A.index))),F&&(z===g&&h(H)&&(B=H(l(E,c),B)),B=v(B,z,z?B.value:B),E=e(b)-e(B),b=r(b,B,a,c,D,x),a=t(a,E,D,x),b=u(b,a,c,x,A));return b}},function(b,c){b.exports=function(a,b){a=a.slice(0,a.depth);a[a.length]=b;return a}},function(b,c,a){var d=a(1),g=a(126),
...
var g=a(82),f=a(81),e=a(103),n=a(5),m=a(107),k=a(108),h=a(117),v=a(116),p=a(31),u=a(7),r=a(1),t=a(3),l=a(8),y=a(21),q=a(35),w=a(33),B=a(20),z=a(39),F=function(){},E=a(89),A=a(27),x=a(57);b.exports=d;d.prototype.constructor=d;d.prototype._materialized=!1;d.prototype._boxed=!1;d.prototype._progressive=!1;d.prototype._treatErrorsAsValues=!1;d.prototype._maxSize=Math.pow(2,53)-1;d.prototype._collectRatio=.75;d.prototype.get=a(110);d.prototype.set=a(112);d.prototype.preload=function(){var a=z(arguments,
x,"preload");if(!0!==a)return new n(function(b){b.onError(a)});var b=Array.prototype.slice.call(arguments),d=this;return new n(function(a){return d.get.apply(d,b).subscribe(function(){},function(b){a.onError(b)},function(){a.onCompleted()})})};d.prototype.call=function(){var a,b=-1,d=arguments.length;for(a=Array(d);++b<d;){var e=arguments[b];a[b]=e;var f=typeof e;if(1<b&&!Array.isArray(e)||0===b&&!Array.isArray(e)&&"string"!==f||1===b&&!Array.isArray(e)&&!l(e))return new n(function(a){a.onError(Error("Invalid argument"))})}return new m(this,
...
p(d,d.expired,u(b),0);var f;q(a)?f=B(this,[a])[0]:y(a)?f=w(this,[a])[0]:r(a)&&(f=w(this,[{json:a}])[0]);f&&A.getWithPathsAsPathMap(this,f,[],!0);this._path=e}else"undefined"===typeof b&&(this._root.cache={});return this};d.prototype.getCache=function(a){for(var b=[],d=0;d<arguments.length;++d)b[d-0]=arguments[d];if(0===b.length)return E(this._root.cache);var d=[{}],e=this._path;A.getWithPathsAsJSONGraph(this,b,d);this._path=e;return d[0].jsonGraph};d.prototype.getVersion=function(a){a=void 0===a?
...
d.prototype._fromWhenceYouCame=function(a){return this._clone({_allowFromWhenceYouCame:void 0===a?!0:a})};d.prototype._getVersion=a(91);d.prototype._getPathValuesAsPathMap=A.getWithPathsAsPathMap;d.prototype._getPathValuesAsJSONG=A.getWithPathsAsJSONGraph;d.prototype._setPathValues=a(34);d.prototype._setPathMaps=a(33);d.prototype._setJSONGs=a(20);d.prototype._setCache=a(33);d.prototype._invalidatePathValues=a(101);d.prototype._invalidatePathMaps=a(100)},function(b,c){function a(a){this._model=a._materialize().boxValues().treatErrorsAsValues()}
...
for(p=0;p<v;++p)w[p]=l[p];p=a._referenceContainer}else h=q,w=[];var l=[],z=a._boxed,F=y.expired,E=a._materialized,A=!!a._source,x=y.branchSelector,C=a._treatErrorsAsValues,D=a._allowFromWhenceYouCame,G=c[0],H=G&&G.json;c={values:c};if(a._recycleJSON&&!0!==u)d(u=b)&&(u=k(m(b))),H=f(q,h,H,u,0,G,c,l,w,v,!1,p,y,F,x,z,E,A,C,D);else for(var I=-1,K=b.length;++I<K;)u=b[I],a=u.length,H=g(q,h,H,u,0,G,c,l,a,w,v,!1,p,y,F,x,z,E,A,C,D);c.hasValue&&(G.json=H);return c}},function(b,c,a){var d=a(13);b.exports=function(a,
b,e,c,m,k){var f=-1;b+=!!m;m=Array(b);for(a=k?d(a):a.value;++f<b;)m[f]=c[f];(e.errors||(e.errors=[])).push({path:m,value:a})}},function(b,c,a){function d(a,b,c,m,u,F,E,A,x,C,D,G,H,I,K,S,R,Y,V,T){var q,y;if(void 0===b||void 0!==(q=b.$type)||void 0===m)return a=q,G=D,K=n,T=g,b&&a?k(b)?(b["\u001e\u0192alcor_invalidated"]||l(b,I,H),b=T(m,u,E,A,u,x,C)):(t(H,b),F?(G&&(A[u]=null),b=K(b,a,u,F,E,A,x,C,G,S,R,V)):b=void 0):R&&!Y?F?(E.hasValue=!0,b={$type:r}):b=void 0:b=T(m,u,E,A,u,x,C),b;var w;q="";var B,z,
L,Q=m.$keys,aa=u+1,U,W,X,ca,Z,da=C+1,fa,ga;T&&G&&(ga=G.value,fa=G["\u001e\u0192alcor_abs_path"]);if(c&&(w=c["\u001e\u0192alcor_metadata"])){if(w.version===b["\u001e\u0192alcor_version"]&&w.$code===m.$code)return E.hasValue=!0,c;w.version=b["\u001e\u0192alcor_version"];w.abs_path=b["\u001e\u0192alcor_abs_path"];w.deref_to=ga;w.deref_from=fa}var ha=-1,ja=Q.length,ba,ea,ia;a:for(;++ha<ja;)if(D=Q[ha],ba=m[ha],ia=!1,null===D){if(void 0!==ba)throw new v;q=""+p(""+q+"null")}else{if("object"!==typeof D)z=
D,U=void 0,L=!1,ea=z;else{U=D.to;z=D.from||0;"number"!==typeof U&&(U=z+(D.length||0)-1);if(0>U-z)break a;L=!0;ea="{from:"+z+",length:"+(U-z+1)+"}"}do D=!1,W=c&&c[z],Z=x,ca=da,X=G,B=b[z],A[u]=z,x[C]=z,B&&void 0!==ba&&B.$type===e&&!k(B)&&(y=h(a,B,H),B=y[0],D=!0,Z=y[1],X=y[2],ca=Z.length,y[0]=y[1]=y[2]=void 0),W=d(a,B,W,ba,aa,F,E,A,Z,ca,D,X,H,I,K,S,R,Y,V,T),void 0!==W?(void 0===w&&(w={},w.version=b["\u001e\u0192alcor_version"],w.abs_path=b["\u001e\u0192alcor_abs_path"],w.deref_to=ga,w.deref_from=fa),
void 0===c&&(K?(c=K(w),c["\u001e\u0192alcor_metadata"]||(c["\u001e\u0192alcor_metadata"]=w)):(c=new f(w),c=Object.create(c))),c[z]=W):(c&&c.hasOwnProperty(z)&&delete c[z],ia=!0);while(L&&++z<=U);q=!0===ia||void 0===ba?""+p(""+q+ea):""+p(""+q+ea+ba.$code)}w&&(w.$code=q);return c}function g(a,b,d,e,c,f,g){a=a?u(a):[[]];var k=e.slice(0,c);a.forEach(function(a){c=b+a.length;m(k.concat(a),b,d,e,c,f,g)})}var f=a(28),e=a(0),n=a(51),m=a(30),k=a(2),h=a(50),v=a(10);a(26);var p=a(4).getHashCode,u=a(4).flatBufferToPaths;
b.exports=d;var r=a(16),t=a(11),k=a(2),l=a(6)},function(b,c,a){function d(a,b,c,y,q,w,B,z,F,E,A,x,C,D,G,H,I,K,S,R,Y){var l,r;if(void 0===b||(l=b.$type)||q===F)return k(b,l,y,q,w,B,z,F,E,A,x,D,G,I,K,S,R,n,m);var t,M,P=q+1,N,O,L,Q,aa=-1,U=0,W,X,ca=A+1,Z,da;x=y[q];if(null===x){if(P<F)throw new p;return c}Y&&C&&(da=C.value,Z=C["\u001e\u0192alcor_abs_path"]);a:do{if("object"!==typeof x)l=x,N=void 0,M=!1;else if(f(x)){if(void 0!==O)throw new u(y,O);aa=0;O=x;U=x.length;if(0===U)break a;x=O[aa];continue a}else{N=
x.to;l=x.from||0;"number"!==typeof N&&(N=l+(x.length||0)-1);if(0>N-l)break a;M=!0}do x=!1,L=c&&c[l],X=E,W=ca,Q=C,t=b[l],z[q]=l,E[A]=l,t&&P<F&&t.$type===e&&!h(t)&&(r=v(a,t,D),t=r[0],x=!0,X=r[1],Q=r[2],W=X.length,r[0]=r[1]=r[2]=void 0),L=d(a,t,L,y,P,w,B,z,F,X,W,x,Q,D,G,H,I,K,S,R,Y),void 0!==L&&(void 0===c&&(x={},x.version=b["\u001e\u0192alcor_version"],x.abs_path=b["\u001e\u0192alcor_abs_path"],x.deref_to=da,x.deref_from=Z,H?(c=H(x),c["\u001e\u0192alcor_metadata"]||(c["\u001e\u0192alcor_metadata"]=
x)):c=new g(x)),c[l]=L);while(M&&++l<=N);if(++aa===U)break a;x=O[aa]}while(1);return c}var g=a(28),f=Array.isArray,e=a(0),n=a(51),m=a(30),k=a(52),h=a(2),v=a(50),p=a(10),u=a(26);b.exports=d},function(b,c,a){var d=a(99),g=a(86);b.exports=function(a,b,c){var e,f,h=a._root,n,p,u=a._path.length;if(u)return{criticalError:new g};p=[];f=e=h.cache;n=[];var r=a._boxed,t=h.expired,l=a._materialized,y=!!a._source;a=a._treatErrorsAsValues;for(var q=c[0],w={values:c},B,z=-1,F=b.length;++z<F;)B=b[z],c=B.length,
d(f,e,B,0,q,w,n,c,p,u,!1,h,t,r,l,y,a);return w}},function(b,c,a){var d=Array(2),g=a(13),f=a(0),e=a(29),n=a(11),m=a(2),k=a(12),h=a(48);b.exports=function(a,b,c,r,t,l){n(c,b);var p,q;t=0;l=a;var w=b.value,u=w,v=w.length;do{if(0===t&&void 0!==(p=b["\u001e\u0192alcor_context"]))l=p,t=v;else if(q=w[t++],void 0===(l=l[q]))break;if(t===v){q=l.$type;if(void 0!==q&&m(l))break;else{if(l===b)throw new h(w);l!==p&&k(b,l)}if(q===f)n(c,l),e(g(l),w,v,r),t=0,b=l,l=a,w=u=b.value,v=w.length;else break}else if(void 0!==
l.$type)break}while(1);t<v&&void 0!==l&&(v=t);t=-1;for(w=Array(v);++t<v;)w[t]=u[t];d[0]=l;d[1]=w;return d}},function(b,c,a){var d=a(13),g=a(0),f=a(16),e=a(17),n=a(29);b.exports=function(a,b,c,v,p,u,r,t,l,y,q){var k=a&&a.value;if(b&&void 0===k)if(q)k={$type:f};else return;else if(y||g===b||e===b||!a["\u001e\u0192alcor_wrapped_value"]||"object"===typeof k)k=d(a);p&&u&&(p.hasValue=!0,n(k,r,t,v,y,q),(v.paths||(v.paths=[])).push(u.slice(0,c+!!l)));return k}},function(b,c,a){function d(a,b,c,q,w,B,z,F,
E,A,x,C,D,G,H,I,K){var l,y;if(void 0===b||(l=b.$type)||q===F)return h(b,l,c,q,w,B,z,F,E,A,x,C,D,G,H,I,K,n,m);var t,V,T=q+1,J,M,P=-1,N=0,O,L,Q=A+1;x=c[q];if(null===x){if(T<F)throw new u;}else{a:do{if("object"!==typeof x)l=x,J=void 0,V=!1;else if(g(x)){if(void 0!==M)throw new r(c,M);P=0;M=x;N=x.length;if(0===N)break a;x=M[P];continue a}else{J=x.to;l=x.from||0;"number"!==typeof J&&(J=l+(x.length||0)-1);if(0>J-l)break a;V=!0}do x=!1,L=E,O=Q,t=b[l],z[q]=l,E[A]=l,t&&T<F&&t.$type===e&&!v(t)&&(k(f(t),E,O,
w),y=p(a,t,C,w,G,H),t=y[0],x=!0,L=y[1],O=L.length,y[0]=y[1]=void 0),d(a,t,c,T,w,B,z,F,L,O,x,C,D,G,H,I,K);while(V&&++l<=J);if(++P===N)break a;x=M[P]}while(1)}}var g=Array.isArray,f=a(13),e=a(0),n=a(98),m=a(30),k=a(29),h=a(52),v=a(2),p=a(97),u=a(10),r=a(26);b.exports=d},function(b,c,a){function d(a,b,c,e,f,m,p,n,u,t){if(!r(a)&&!a.$type)for(var q in a)if("\u001e"!==q[0]&&"$"!==q[0]&&h(a,q)){var w=a[q],B=v(w)&&!w.$type,x=g(c,e,f,q,w,B,!1,m,p,n,u,t),z=x[0],x=x[1];z&&(B?d(w,b+1,c,x,z,m,p,n,u,t):y(z,x,q,
n)&&l(x,k(z),n,m))}}function g(a,b,d,c,l,k,h,n,y,u,v,H){for(h=d.$type;h===e;){a:{b=l;h=a;var q=n,w=y,x=u,z=v,B=H;if(p(d))t(d,w,x),b=[void 0,h];else{m(x,d);var A=d,E=d.value,D;d=d["\u001e\u0192alcor_context"];if(null!=d)D=d["\u001e\u0192alcor_parent"]||h;else{var F=0,C=E.length-1;D=d=h;do{D=g(h,D,d,E[F],b,F<C,!0,q,w,x,z,B);d=D[0];if(r(d)){b=D;break a}D=D[1]}while(F++<C);A["\u001e\u0192alcor_context"]!==d&&f(A,d)}b=[d,D]}}d=b[0];if(r(d))return b;b=b[1];h=d&&d.$type}if(void 0!==h)return[d,b];if(null==
...
a.arguments)});a.onCompleted();a=b._root;var d=a.onChangesCompleted;this.initialCacheVersion!==a.cache["\u001e\u0192alcor_version"]&&0>=a.syncRefCount&&k(d)&&d.call(a.topLevelModel);return m};b.exports=d},function(b,c,a){function d(a,b){var d=[],c,e;c=0;for(e=a.length;c<e;c++)d[c]=a[c];a=0;for(e=b.length;a<e;a++)d[c++]=b[a];return d}var g=a(56),f=a(49),e=a(31),n=a(7),m=a(55),k=a(9),h=a(3);b.exports=function p(a,b,c,l,y,q,w,B,z){if(10===q)throw new f;var r=b._request,t=c.requestedMissingPaths,u=c.optimizedMissingPaths,
x=new m,C=[],D=b._path;if(D.length)for(var G=0,H=t.length;G<H;++G)C[G]=d(D,t[G]);else C=t;var I=a.isProgressive||!z?t:B,r=r.get(C,u,function(d){if(d instanceof k)l.onError(d);else if(d=g(b,I,l,a.isProgressive,a.isJSONGraph,c.values,y,z))x.currentDisposable=p(a,b,d,l,y,q+1,w,B,z);else{d=b._root;var f=d.cache,m=f["\u001e\u0192alcor_version"];e(d,d.expired,n(f),b._maxSize,b._collectRatio,m);f=d.onChangesCompleted;w!==m&&0>=d.syncRefCount&&h(f)&&f.call(d.topLevelModel)}});x.currentDisposable=r;return x}},
...
a.charAt(0)}},function(b,c,a){var d=a(0),g=a(17),f=a(7),e=a(59),n=a(1),m=a(2),k=a(3),h=a(65),v=a(60),p=a(6),u=a(63),r=a(15),t=a(62);b.exports=function(a,b,c,w,B,z,F,E,A,x,C){var l,q,y,I,K,S;if(b===c){if(null===c)return b=h(c,void 0,c),a=r(a,-b.$size,A,F),b=v(b,a,w,void 0,z);if(void 0===c)return c;if(y=n(b))if(l=b.$type,null==l)return null==b["\u001e\u0192alcor_parent"]&&v(b,a,w,F,z),b}else if(y=n(b))l=b.$type;if(l!==d){if(I=n(c))q=c.$type;if(y&&!l&&(null==c||I&&!q))return b}else{if(null==c){if(m(b)){p(b,
E,A);return}return b}if(I=n(c))if(q=c.$type,q===d)if(b===c){if(null!=b["\u001e\u0192alcor_parent"])return b}else if(K=b.$timestamp,S=c.$timestamp,!m(b)&&!m(c)&&S<K)return}if(l&&I&&!q)return v(u(b,c,a,w,A,F),a,w,void 0,z);q||!I?(q===g&&k(C)&&(c=C(t(B,w),c)),q&&b===c?null==b["\u001e\u0192alcor_parent"]&&(b=h(b,l,b.value),a=r(a,-b.$size,A,F),b=v(b,a,w,F,z)):(B=!0,(l&&!m(b)||!y)&&(B=!1===e(c)<e(b))&&(l||q)&&k(x)&&(B=!x(b,c,z.slice(0,z.index))),B&&(c=h(c,q,q?c.value:c),x=f(b)-f(c),b=u(b,c,a,w,A,F),a=r(a,
x,A,F),b=v(b,a,w,F,z))),m(b)&&p(b,E,A)):null==b&&(b=v(c,a,w,void 0,z));return b}},function(b,c,a){b.exports=function(a,b){for(var d=a["\u001e\u0192alcor_refs_length"]||0,c=b["\u001e\u0192alcor_refs_length"]||0,g=-1;++g<d;){var m=a["\u001e\u0192alcor_ref"+g];void 0!==m&&(m["\u001e\u0192alcor_context"]=b,b["\u001e\u0192alcor_ref"+(c+g)]=m,a["\u001e\u0192alcor_ref"+g]=void 0)}b["\u001e\u0192alcor_refs_length"]=d+c;a["\u001e\u0192alcor_refs_length"]=void 0;return b}},function(b,c,a){b.exports=function(a){for(var b=
