...
f,a._source,new q);b=c.subscribe(new x(b,c));f.add(c);c.data=e;c.boundPath=a._path;c.connect();return b})};c.prototype.get=function(a,b,c){return new f(this,a._source,a._scheduler,c,b)};f.prototype.subscribe=function(a){for(var b=this.queue,c=this.dataSource,d=this.requested,e=this.optimized,f=this.scheduler,h=-1,l=b.subscriptions,p=l.length,q=new m([],a);++h<p;){var y=l[h];if("get"===y.type&&((y=y.batch(d,e,d=[],e=[]))&&q.add(y.subscribe(new x(a,y))),!e.length))break}e.length&&(y=l[h]=(new g("get",
b,c,f)).batch(d,e),q.add(y.subscribe(new x(a,y))),y.connect());return q}},function(b,e,a){function c(a,b,c,d){g.call(this,[],b);this.trees=[];this.type=a;this.data=null;this.responded=this.active=!1;this.paths=null;this.requested=[];this.optimized=[];this.disposable=null;this.dataSource=c;this.scheduler=d}function f(){var a,b=this.paths=t(u(this.optimized.reduce(function(a,b){return r(b,a)},{})));this.trees=this.optimized.map(function(a){return u(r(a))});this.active=!0;try{switch(this.type){case "get":a=
this.dataSource.get(b);break;case "set":a=this.dataSource.set({paths:b,jsonGraph:this.data});break;case "call":a=this.dataSource.call.apply(this.dataSource,this.data)}this.disposable=a.subscribe(this)}catch(l){this.disposable={},g.prototype.onError.call(this,new x(l))}}function d(a,b){var c;if(!a||0===(c=a.length))return b;var d=[],e=-1,f,g,h=-1,k=b.length;a:for(;++h<k;)if(g=b[h],g.length>c){f=0;do if(g[f]!==a[f])continue a;while(++f<c);d[++e]=g.slice(c)}return d}var g=a(97);a(14);a(15);var x=a(53),
m=a(18),q=a(30),p=a(28),t=a(39),r=a(37),u=a(38),n=a(63);b.exports=c;c.prototype=Object.create(g.prototype);c.prototype.next=c.prototype.onNext=function(a){var b=this.parent;if(b){this.responded=!0;var c=!1,e=a.jsonGraph,f=this.boundPath,b=b.modelRoot,g=a.invalidated,k=a.paths||this.paths,n=this.requested.slice(0);a=this.observers.slice(0);var q=b.onChange;g&&g.length&&(c=p({_root:b,_path:[]},g,!1));k&&k.length&&e&&"object"===typeof e&&(e=m({_root:b},[{paths:k,jsonGraph:e}],b.errorSelector,b.comparator,
...
function(a,b,c,d){if(this.active){var e=[],f=[],g=this.trees,h=-1,k=-1,l=-1,m=-1,p=-1,q=g.length,t=b.length,w=a.length-1;a:for(;++h<t;){for(var x=-1,L=b[h],N=L.length;++x<q;){var S=g[x][N];if(S&&n(S,L,0,N)){f[++m]=L;p<w&&(e[++p]=a[h<w?h:w]);continue a}}d[++k]=L;l<w&&(c[++l]=a[h<w?h:w])}return~m?(this.requested.push(e),this.optimized.push(f),this.trees.push(u(r(f))),this):null}this.trees.push({});this.requested.push(a);this.optimized.push(b);return this}},function(b,e,a){function c(a,b){f.call(this,
...
e["default"]=b}).call(e,a(35),a(106)(b))},function(b,e,a){Object.defineProperty(e,"__esModule",{value:!0});e["default"]=function(a){var b=a.Symbol;"function"===typeof b?b.observable?a=b.observable:(a=b("observable"),b.observable=a):a="@@observable";return a}},function(b,e){b.exports=function(a){a.webpackPolyfill||(a.deprecate=function(){},a.paths=[],a.children||(a.children=[]),Object.defineProperty(a,"loaded",{enumerable:!0,get:function(){return a.l}}),Object.defineProperty(a,"id",{enumerable:!0,
get:function(){return a.i}}),a.webpackPolyfill=1);return a}},function(b,e,a){b.exports=a(61)}])});
