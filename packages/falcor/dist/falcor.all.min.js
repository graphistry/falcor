...
(this.branchSelector=a.branchSelector);"function"===typeof a.errorSelector&&(this.errorSelector=a.errorSelector);"function"===typeof a.branchSelector&&(this.branchSelector=a.branchSelector);"function"===typeof a.onChange&&(this.onChange=a.onChange);"function"===typeof a.onChangesCompleted&&(this.onChangesCompleted=a.onChangesCompleted)}var f=a(96),e=a(33);c.comparator=c.prototype.comparator=function(a,b){var c=a&&a.$type,d=b&&b.$type;if(c){if(d){if(c!==d||!0!==e(b)<e(a)&&(a.value!==b.value||a.$expires!==
b.$expires))return!1}else return a.value===b;return!0}return d?!1:a===b};b.exports=c},function(b,d,a){var c=a(25),f=a(26);b.exports={json:function(a,b,d,f){var e=!1;if(!b)return{missing:!1,hasValue:!1};var h=[].concat(b[1]||[]),n=[].concat(b[2]||[]),p=[].concat(b[3]||[]);b=(a._path||[]).concat(b[0]||[]);f&&p&&p.length&&(e=c(a,p,d,f,!0).hasValue);return{data:d,missing:!0,hasValue:e,fragments:[b,h,n,p]}},jsonGraph:function(a,b,c,d){var e=!1;if(!b)return{missing:!1,hasValue:!1};var h=[].concat(b[1]||
[]),n=[].concat(b[2]||[]),p=[].concat(b[3]||[]);b=(a._path||[]).concat(b[0]||[]);d&&p&&p.length&&(e=f({_root:a._root,_boxed:a._boxed,_materialized:a._materialized,_treatErrorsAsValues:a._treatErrorsAsValues},p,c,!0,!0).hasValue);return{data:c,missing:!0,hasValue:e,fragments:[b,h,n,p]}}}},function(b,d,a){b.exports={json:a(40),jsonGraph:a(43)}},function(b,d,a){var c=a(7);b.exports=function(a,b,d,y,n,q){var e=-1;b+=!!n;n=Array(b);for(a=q?c(a):a.value;++e<b;)n[e]=y[e];(d.errors||(d.errors=[])).push({path:n,
value:a})}},function(b,d,a){function c(a,b,d,m,u,D,w,z,C,B,E,A,F,H,J,L,P,R,S,T,K){var g,l;if(void 0===b||void 0!==(g=b.$type)||void 0===m)return e[1]=S&&void 0===b,e[0]=q(b,g,d,m,u,D,w,z,u,C,B,E,F,H,J,L,P,R,S,T,h,f,p),e;var t,x,G;g="";var M,I,V,Y=m.$keys,ba=u+1,Z,X,aa,fa,ca,ga=B+1,ha,ia;K&&A&&(ia=A.value,ha=A["\u001e\u0192_abs_path"]);if(!d||"object"!==typeof d)d=void 0;else if(t=d["\u001e\u0192_meta"]){G=b["\u001e\u0192_abs_path"];x=t.abs_path;L||d instanceof y||(d.__proto__={},d.__proto__["\u001e\u0192_meta"]=
t,d.__proto__.__proto__=y.prototype);if(G!==x){t.$code="__incomplete__";t.abs_path=G;t.version=b["\u001e\u0192_version"];t.deref_to=ia;t.deref_from=ha;if(x=t.keys)for(I in t.keys=Object.create(null),x)x[I]&&delete d[I];e[0]=d;e[1]=!0;return e}if(t.version===b["\u001e\u0192_version"]&&t.$code===m.$code)return w.hasValue=!0,e[0]=d,e[1]=!1,e;x=t.keys;t.abs_path=G;t.version=b["\u001e\u0192_version"];t.deref_to=ia;t.deref_from=ha}G=Object.create(null);var ja=-1,la=Y.length,ea,ka,da=!1;a:for(;++ja<la;)if(E=
Y[ja],ea=m[ja],null===E){if(void 0!==ea)throw new r;g=""+k(""+g+"null")}else{if("object"!==typeof E)I=E,Z=void 0,V=!1,ka=I;else{Z=E.to;I=E.from||0;"number"!==typeof Z&&(Z=I+(E.length||0)-1);if(0>Z-I)break a;V=!0;ka="["+I+".."+Z+"]"}do{E=!1;X=d&&d[I];ca=C;fa=ga;aa=A;M=b[I];z[u]=I;C[B]=I;if(void 0===ea){if(e=c(a,M,X,ea,ba,D,w,z,ca,fa,E,aa,F,H,J,L,P,R,S,T,K),X=e[0],da=da||e[1],void 0===X&&!R){da=!0;d&&d.hasOwnProperty(I)&&delete d[I];continue}}else if(M&&"ref"===M.$type&&!n(M,J)&&(l=v(a,M,F,J),M=l[0],
E=!0,ca=l[1],aa=l[2],fa=ca.length,l[0]=l[1]=l[2]=void 0),e=c(a,M,X,ea,ba,D,w,z,ca,fa,E,aa,F,H,J,L,P,R,S,T,K),X=e[0],da=da||e[1],void 0===X){da=!0;d&&d.hasOwnProperty(I)&&delete d[I];continue}void 0===t&&(t={},t.version=b["\u001e\u0192_version"],t.abs_path=b["\u001e\u0192_abs_path"],t.deref_to=ia,t.deref_from=ha,d={},d["\u001e\u0192_meta"]=t,d.__proto__=y.prototype,L?d=L(d):(E=d,d={},d.__proto__=E));G[I]=!0;x&&I in x&&(x[I]=!1);d[I]=X}while(V&&++I<=Z);da||(g=""+k(""+g+ka+(ea&&ea.$code||"")))}da&&(g=
"__incomplete__");if(t&&(t.$code=g,t.keys=G,x))for(I in x)x[I]&&delete d[I];e[0]=d;e[1]=da;return e}function f(a,b,c,e,d,h,k,r,q,n,p,v,y,H){if(n)return H(p,a,b,b,v,y,c,e,k,r,h,q,f);a=a?u(a):[[]];var g=e.slice(0,d);return a.forEach(function(a){d=b+a.length;return m(g.concat(a),b,c,e,d,h,k,r,q,!1,p,v,y,H)})}var e=Array(2),h=a(42),y=a(2),n=a(0),q=a(16),m=a(28),v=a(41),p=a(79),r=a(3);a(12);var k=a(23),u=a(22);b.exports=c},function(b,d,a){function c(a,b,g,d,t,G,x,D,w,z,C,B,E,A,F,H,J,L,P,R,S,T){var l,k;
if(void 0===b||(l=b.$type)||t===w)return n(b,l,g,d,t,G,x,D,w,z,C,B,A,F,H,J,L,P,R,S,e,h,m);var u,Q,N,U=t+1,M,I,V,Y,ba=-1,Z=0,X,aa,fa=C+1,ca,ga;B=d[t];if(null===B){if(U<w)throw new p;return g}T&&E&&(ga=E.value,ca=E["\u001e\u0192_abs_path"]);if(!g||"object"!==typeof g)g=void 0;else if(u=g["\u001e\u0192_meta"])u.version=b["\u001e\u0192_version"],u.abs_path=b["\u001e\u0192_abs_path"],u.deref_to=ga,u.deref_from=ca;a:do{if("object"!==typeof B)l=B,M=void 0,N=!1;else if(f(B)){if(void 0!==I)throw new r(d,I);
ba=0;I=B;Z=B.length;if(0===Z)break a;B=I[ba];continue a}else{M=B.to;l=B.from||0;"number"!==typeof M&&(M=l+(B.length||0)-1);if(0>M-l)break a;N=!0}do{B=!1;V=g&&g[l];aa=z;X=fa;Y=E;Q=b[l];D[t]=l;z[C]=l;if(U===w){if(V=c(a,Q,V,d,U,G,x,D,w,aa,X,B,Y,A,F,H,J,L,P,R,S,T),void 0===V&&!P)continue}else if(Q&&"ref"===Q.$type&&!q(Q,H)&&(k=v(a,Q,A,H),Q=k[0],B=!0,aa=k[1],Y=k[2],X=aa.length,k[0]=k[1]=k[2]=void 0),void 0===(V=c(a,Q,V,d,U,G,x,D,w,aa,X,B,Y,A,F,H,J,L,P,R,S,T)))continue;void 0===u&&(u={},u.version=b["\u001e\u0192_version"],
u.abs_path=b["\u001e\u0192_abs_path"],u.deref_to=ga,u.deref_from=ca,g={},g["\u001e\u0192_meta"]=u,g.__proto__=y.prototype,J&&(g=J(g)));g[l]=V}while(N&&++l<=M);if(++ba===Z)break a;B=I[ba]}while(1);return g}var f=Array.isArray,e=a(42),h=a(28),y=a(2),n=a(16),q=a(0),m=a(44),v=a(41),p=a(3),r=a(12);a(6);b.exports=c},function(b,d,a){var c=Array(2),f=a(7),e=a(27),h=a(13),y=a(0),n=a(8),q=a(53);b.exports=function(a,b,d,r,k){h(d,b);var m,g,l=0,t=a,p=b.value,x=p,v=p.length;do{if(0===l&&void 0!==(m=b["\u001e\u0192_context"]))t=
m,l=v;else if(g=p[l++],void 0===(t=t[g]))break;if(l===v){g=t.$type;if(void 0!==g&&y(t,k))break;else{if(t===b)throw new q(p);t!==m&&n(b,t)}if("ref"===g)h(d,t),r&&e(f(t),p,v,r),l=0,b=t,t=a,p=x=b.value,v=p.length;else break}else if(void 0!==t.$type)break}while(1);l<v&&void 0!==t&&(v=l);l=-1;for(p=Array(v);++l<v;)p[l]=x[l];c[0]=t;c[1]=p;return c}},function(b,d,a){var c=a(7),f=a(27);b.exports=function(a,b,d,n,q,m,v,p,r,k,u){u=a.value;if(k||"ref"===b||"error"===b||!a["\u001e\u0192_wrapped_value"]||"object"===
typeof u)u=c(a);q.hasValue=!0;f(u,v,p,n);(n.paths||(n.paths=[])).push(m.slice(0,d+!!r));return u}},function(b,d,a){function c(a,b,g,d,p,w,z,C,B,E,A,F,H,J,L,P,R,S){var l,t;if(void 0===b||(l=b.$type)||d===C)return m(b,l,p,g,d,p,w,z,C,B,E,A,F,H,J,void 0,L,P,R,S,y,f,v);var x,G,D=d+1,N,U,M=-1,I=0,V,Y,ba=E+1;A=g[d];if(null===A){if(D<C)throw new k;}else{a:do{if("object"!==typeof A)l=A,N=void 0,G=!1;else if(e(A)){if(void 0!==U)throw new u(g,U);M=0;U=A;I=A.length;if(0===I)break a;A=U[M];continue a}else{N=
A.to;l=A.from||0;"number"!==typeof N&&(N=l+(A.length||0)-1);if(0>N-l)break a;G=!0}do A=!1,Y=B,V=ba,x=b[l],z[d]=l,B[E]=l,x&&D<C&&"ref"===x.$type&&!q(x,J)&&(p&&n(h(x),B,V,p),t=r(a,x,F,p,J),x=t[0],A=!0,Y=t[1],V=Y.length,t[0]=t[1]=void 0),c(a,x,g,D,p,w,z,C,Y,V,A,F,H,J,L,P,R,S);while(G&&++l<=N);if(++M===I)break a;A=U[M]}while(1)}}function f(a,b,c,e,d,f,k,r,m,q,u,v,y,J){var l,t;u&&q&&((u.paths||(u.paths=[])).push((t=0===d-b)&&e.slice(0,b+!!f)||e.slice(0,b).concat(a.slice(b,d+!!f))),l=n(t&&h(g)||void 0,
k,r,u,!t));return p(a,b,c,e,d,f,k,r,m,!t&&q,l,v,!0,J)}var e=Array.isArray,h=a(7),y=a(77),n=a(27),q=a(0),m=a(16),v=a(44),p=a(28),r=a(76),k=a(3),u=a(12),g=a(6);b.exports=c},function(b,d,a){function c(a,b,d,p,r,k,u,g,l,t,G,x,D){if(void 0===b)return e(void 0,void 0,a,b,d,void 0,u,g,d,l,t,G,void 0,void 0,!1,r,k,!1,x,!1,void 0,D,void 0),k?f(n):void 0;var m,q,v,B,E=b.$keys,A=d+1,F,H=t+1;a&&"object"===typeof a?((p=a["\u001e\u0192_meta"])?m=p.keys:(a["\u001e\u0192_meta"]=p={},p.version=0),p.abs_path=l.slice(0,
t)):(a={},a.__proto__=h.prototype,a["\u001e\u0192_meta"]=p={},p.version=0,p.abs_path=l.slice(0,t),r&&(a=r(a)));q={};var J,L=-1,P=E.length;a:for(;++L<P;)if(B=E[L],J=b[L],null===B){if(void 0!==J)throw new y;}else{if("object"!==typeof B)v=B,F=void 0,B=!1;else{F=B.to;v=B.from||0;"number"!==typeof F&&(F=v+(B.length||0)-1);if(0>F-v)break a;B=!0}do g[d]=v,l[t]=v,q[v]=!0,m&&v in m&&(m[v]=!1),a[v]=c(a[v],J,A,A,r,k,u,g,l,H,G,x,D);while(B&&++v<=F)}p.$code="__incomplete__";p.keys=q;if(m)for(v in m)m[v]&&delete a[v];
return a}var f=a(7),e=a(16),h=a(2),y=a(3);a(12);var n=a(6);b.exports=c},function(b,d,a){function c(a,b,d){a&&"object"===typeof a&&Object.keys(a).filter(function(b){return("$type"===b||!f(b))&&void 0!==a[b]}).forEach(function(e){var d=a[e],h=b[e];h||(h=b[e]={});if(d.$type){h=!d["\u001e\u0192_wrapped_value"];if(d.value&&"object"===typeof d.value||h){var h={},n=Object.keys(d),p,r,k;r=0;for(k=n.length;r<k;r++)p=n[r],"$type"!==p&&f(p)||(h[p]=d[p]);d=h}else d=d.value;b[e]=d}else c(d,h,e)})}var f=a(21);
b.exports=function(a){var b={};c(a,b);return b}},function(b,d,a){var c=a(17);b.exports=function(a,b){a=(a=c(a,b))&&a["\u001e\u0192_version"];return null==a?-1:a}},function(b,d,a){function c(a,c,d,q,m){c=e(c);d=-1;for(q=c.length;++d<q;){var h=c[d],p=h.inputType,h=h.arguments;0<h.length&&("PathValues"===p&&(h=h.map(f)),b.exports["invalidate"+p](a,h,m))}return{}}function f(a){return a.path||a.paths}var e=a(45);b.exports={json:c,jsonGraph:c,invalidatePathMaps:a(47),invalidatePathValues:a(29)}},function(b,
d,a){var c=a(52),f=a(0),e=a(46),h=a(1),y=a(50),n=a(9),q=a(49),m=a(33),v=a(11);b.exports=function(a,b,d,u,g,l,t,G,x,D,w,z){var k,p,r,A,F,H;if(b===d){if(void 0===d)return d;if(null===d)return b=c(d,void 0,d),a=v(a,-b.$size,x,t),b=e(b,a,u,void 0,l);if((r=!(!b||"object"!==typeof b))&&void 0===(k=b.$type))return void 0===b["\u001e\u0192_parent"]&&e(b,a,u,t,l),b}else if(r=!(!b||"object"!==typeof b))k=b.$type;if("ref"!==k){if(A=!(!d||"object"!==typeof d))p=d.$type;if(r&&!k&&(null==d||A&&!p))return b}else{if(null==
d){if(f(b,z)){h(b,G,x);return}return b}if(A=!(!d||"object"!==typeof d))if(p=d.$type,"ref"===p)if(b===d){if(null!=b["\u001e\u0192_parent"])return b}else if(F=b.$timestamp,H=d.$timestamp,!f(b,z)&&!f(d,z)&&H<F)return}if(k&&A&&!p)return e(y(b,d,a,u,x,t),a,u,void 0,l);p||!A?("error"===p&&w&&(d=w(q(g,u),d)),p&&b===d?b["\u001e\u0192_parent"]||(b=c(b,k,b.value),a=v(a,-b.$size,x,t),b=e(b,a,u,t,l)):(g=!0,k||p?r&&f(b,z)||(g=D?!(3>D.length?D(b,d):D(b,d,l.slice(0,l.index))):!1===m(d)<m(b)):g=!0,g&&(D=n(b)-n(d=
c(d,p,p?d.value:d)),b=y(b,d,a,u,x,t),a=v(a,D,x,t),b=e(b,a,u,t,l))),f(b,!0)&&h(b,G,x)):null==b&&(b=e(d,a,u,void 0,l));return b}},function(b,d,a){function c(a,c,e){var d=!1,h=-1,k=c.length,m=[],g=[],l=a._root,t=l.errorSelector;e=e&&!a._source;for(l=a._source?null:l.comparator;++h<k;){var n=c[h],q=n.inputType,n=n.arguments;if(0<n.length){var v=(0,b.exports["set"+q])(a,n,t,l,e),d=d||v[2];g.push.apply(g,v[1]);"PathValues"===q?m.push.apply(m,n.map(f)):"JSONGraphs"===q?m.push.apply(m,y(n,f)):m.push.apply(m,
v[0])}}return{changed:d,requested:m,optimized:g}}function f(a){return a.path||a.paths}var e=a(25),h=a(26),y=a(100),n=a(45);b.exports={json:function(a,b,d,f,r){var k,m,g,l,t,p,q=n(b);k=c(a,q,r);if((b=k.requested).length){if(!(g=k.changed)||f)m=e(a,b,d,f,r);g&&(a=h({_root:a._root,_boxed:a._boxed,_materialized:!0,_treatErrorsAsValues:a._treatErrorsAsValues},k.optimized,{},f,r),t=a.data,l=t.paths,p=a.requested)}return{args:q,data:d,missing:l,relative:b,fragments:t,requested:p,error:m&&m.error,errors:m&&
m.errors,hasValue:m&&m.hasValue}},jsonGraph:function(a,b,e,d,f){var k,m,g,l,t,p=n(b);b=c(a,p,f);(m=b.requested).length&&(d||b.changed)&&(k=h({_root:a._root,_boxed:a._boxed,_materialized:!0,_treatErrorsAsValues:a._treatErrorsAsValues},b.optimized,e,d,f),l=k.data,g=l.paths,t=k.requested);return{args:p,data:e,missing:g,relative:m,fragments:l,requested:t,error:k&&k.error,hasValue:k&&k.hasValue}},setPathMaps:a(20),setPathValues:a(31),setJSONGraphs:a(19)}},function(b,d,a){b.exports=function(a,b){for(var c=
a["\u001e\u0192_refs_length"]||0,d=b["\u001e\u0192_refs_length"]||0,f=-1;++f<c;){var n=a["\u001e\u0192_ref"+f];void 0!==n&&(n["\u001e\u0192_context"]=b,b["\u001e\u0192_ref"+(d+f)]=n,a["\u001e\u0192_ref"+f]=void 0)}b["\u001e\u0192_refs_length"]=c+d;a["\u001e\u0192_refs_length"]=void 0;return b}},function(b,d,a){b.exports=function(a){for(var b=-1,c=a["\u001e\u0192_refs_length"]||0;++b<c;){var d=a["\u001e\u0192_ref"+b];null!=d&&(d["\u001e\u0192_context"]=d["\u001e\u0192_ref_index"]=a["\u001e\u0192_ref"+
b]=void 0)}a["\u001e\u0192_refs_length"]=void 0;return a}},function(b,d,a){b.exports=function(a){var b=a["\u001e\u0192_context"];if(b){for(var c=(a["\u001e\u0192_ref_index"]||0)-1,d=(b["\u001e\u0192_refs_length"]||0)-1;++c<=d;)b["\u001e\u0192_ref"+c]=b["\u001e\u0192_ref"+(c+1)];b["\u001e\u0192_refs_length"]=d;a["\u001e\u0192_ref_index"]=a["\u001e\u0192_context"]=void 0}return a}},function(b,d,a){b.exports=function(){var a=this._referenceContainer;return this._allowFromWhenceYouCame&&!0!==a?!1===a||
a&&void 0===a["\u001e\u0192_parent"]||a&&a["\u001e\u0192_invalidated"]?!1:!0:!0}},function(b,d,a){var c=a(2),f=a(10);a(91);b.exports=function(a){var b,d;if(!a||"object"!==typeof a||!(d=a["\u001e\u0192_meta"])||"object"!==typeof d)return null;var e=this._root.cache,q=this._recycleJSON,m=d.abs_path,v,p;if(!m)return q&&(b={json:a},b.__proto__=c.prototype),this._clone({_node:void 0,_seed:b});if(0===m.length)return q&&(b={json:a},b.__proto__=c.prototype),this._clone({_node:e,_path:m,_referenceContainer:!0,
_seed:b});var r=d.deref_to,k=d.deref_from,u=f(e,m),g="e";if(k){g=!1;d=-1;p=k.length;for(v=e;++d<p&&(v=v[k[d]],v&&!v.$type););if(r&&v&&"ref"===v.$type)for(g=!0,p=r.length,e=v.value,d=0;d<p;++d)if(e[d]!==r[d]){u=void 0;g=!1;break}}g?"e"===g&&(v=!0):v=!1;q&&(b={json:a},b.__proto__=c.prototype);return this._clone({_seed:b,_node:u,_path:m,_referenceContainer:v})}},function(b,d,a){d=a(4);b.exports=d("BoundJSONGraphModelError",function(){this.message="It is not legal to use the JSON Graph format from a bound Model. JSON Graph format can only be used from a root model."})},
