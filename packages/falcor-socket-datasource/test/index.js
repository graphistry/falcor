...
import { FalcorPubSubDataSource } from "../source/index.js";
/* eslint-disable */
        ...
        describe("Socket DataSource", () => {
            ...
            beforeEach(() => {
                ...
                model = new Falcor.Model({
                    source: new FalcorPubSubDataSource(
                        new SocketIoClient(server.getUrl(), { forceNew: true })
                    )
                });
            });
            ...
            it("should cancel a get operation", (done) => {
                const messages = [];
                const eventName = "falcor-operation";
                const cancelName = "cancel-falcor-operation";
